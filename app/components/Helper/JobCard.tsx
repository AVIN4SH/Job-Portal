...
const JobCard = ({ job }: Props) => {
  return (
    <div className="p-4 mb-3 relative border-2 cursor-pointer hover:scale-105 hover:shadow-sm transition-all duration-300 border-gray-500 rounded-lg border-opacity-10">
